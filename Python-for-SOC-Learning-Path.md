...
I'm relearning Python through a broad general-purpose course covering everything from game development to deployment — most of it useful for someone, but not all of it useful for my goal: scripting and automation for cybersecurity work. This doc filters that course down to what actually matters for SOC work, so I'm not spread across 30 tools when 10 would make me dangerous in this field.
...
| **Git, GitHub & Version Control** | Core | Every script I write should be tracked, documented, and reusable |
